'use strict';
// NOTE deleted a lot of other code and had to copy this into it.  It was ours already :) not plagerizing.
...
app.get('/new', function(req, res) {
  // app.sendFile('./new.html', {root:'.'});  // NOTE . specifies all directories
